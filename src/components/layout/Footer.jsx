        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          {isMobile && (
            <div style={{
              ...
              <p style={{ fontSize: 14, lineHeight: 1.8, color: 'rgba(255,255,255,0.55)', fontFamily: 'var(--font-body)', maxWidth: 320 }}>
                Riveyra Infotech is a trusted IT company in Kanpur delivering innovative, secure, and scalable digital solutions that help businesses grow and succeed across India and beyond.
          ...
          <div style={{
            ...
            {!isMobile && (
              <div>
                ...
                <p style={{ fontSize: 14.5, lineHeight: 1.88, color: 'rgba(255,255,255,0.6)', marginBottom: 30, fontFamily: 'var(--font-body)', maxWidth: 340 }}>
                  Riveyra Infotech is a trusted IT company in Kanpur delivering innovative, secure, and scalable digital solutions that help businesses grow and succeed across India and beyond.
                </p>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {services.map((item, index) => (
                  <li key={item._id || index} style={{ marginBottom: 10 }}>
                    <span
                      onClick={() => navigate(`/ServiceCategories/${item.categorySlug || item.slug}`)}
                      style={{
