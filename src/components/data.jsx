...
export const ALL_SERVICES_DATA = [
  ...
  },
  {
    ...
    hero: {
      ...
      title: "AI-Powered Web Development Services for Business",
      subtitle: "Smart, Fast & Scalable Solutions",
      intro: "AI is irreplaceable.",
      desc: [
        "Almost every modern business now depends on AI-driven systems.",
        "Businesses compete based on speed, automation, and customer experience.",
        "You may already use CMS, billing systems, or support tools, but still face workflow issues.",
        "AI web development connects, simplifies, and improves your existing systems.",
        "Instead of adding more tools, AI helps everything work together efficiently."
      ]
    },

    blocks: [
      {
        label: "What is AI Web Development?",
        title: "Smart Website & Application Development",
        desc: "AI web development includes smart design, development, and maintenance of websites and applications.",
        features: [
          "UI/UX Designing",
        ...
        extra: "It upgrades your business systems from manual to smart mode."
      },

      {
        label: "Why Businesses Choose AI Web Development",
        title: "Faster Growth & Better User Experience",
        desc: "Businesses use AI web development to stay ahead in competition.",
        features: [
          "Smarter systems",
          "Higher efficiency",
          "Faster growth",
      ...
      {
        label: "Custom AI Applications",
        title: "Personalized AI Applications for Businesses",
        desc: "Customization helps improve engagement and conversions.",
        features: [
      ...
      {
        label: "AI UI/UX Design Development",
        title: "AI Accelerated UI/UX Development",
        desc: "AI helps automate research, wireframing, and mockup creation.",
        features: [
          "Rapid ideation",
          "Personalized user experience",
          "Automated styling",
          "Editable fast-paced designs"
        ]
      },

      {
        label: "AI CMS Development",
        title: "AI-Powered Content Management Systems",
        desc: "AI CMS integrates machine learning into content management.",
        features: [
          "Automated content creation",
          "SEO optimization",
          "AI-powered tagging",
          "Hyper personalization",
          "GEO-target AI websites"
        ]
      },

      {
        label: "AI E-Commerce Website",
        title: "Smart AI E-Commerce Development",
        desc: "AI improves online stores with automation and personalization.",
        features: [
...

      {
        ...
        desc: "AI automates repetitive business tasks and workflows.",
        features: [
          "Workflow automation",
          "Document management",
          "Tool integrations",
    ...
    comparison: {
      title: "Traditional vs AI Web Development",
      data: [
        {
          feature: "Development Speed",
          traditional: "Time Extensive",
          ai: "Extremely Fast"
        },
        {
        ...
        },
        {
          ...
          ai: "Business Owns Data"
        }
      ]
    },

    whoNeeds: {
      title: "Who Needs AI Web Development?",
      idealFor: [
        "Small businesses",
        "Startups",
      ...
      steps: [
        {
          ...
          desc: "Improve business growth using AI-powered systems."
        },
        {
          number: "02",
          title: "Personalization",
          desc: "Customize experiences based on users."
        },
        {
          number: "03",
          title: "Automation",
        ...
        },
        {
          number: "04",
          title: "Scalability",
          desc: "Scale your systems and business efficiently."
        }
      ]
    },
    ...
    faq: [
      {
        q: "How is AI web development different from traditional development?",
        a: "AI development uses automation and machine learning instead of only manual coding."
      },
      {
        q: "Are AI-built websites SEO friendly?",
        a: "Yes, AI tools help with SEO optimization but advanced SEO still requires expert support."
      },
      {
        q: "Is AI web development secure?",
        a: "Security depends on the platform and implementation."
      }
    ]
  },

  {
    ...
    hero: {
      badge: "📊 AI Data Analytics & BI",
      title: "AI Data Analytics & Business Intelligence Services",
      subtitle: "Transform Raw Data into Smart Business Decisions",
      intro:
        "Data plays a critical role in business growth, client management, risk analysis, and predictive decision-making.",

      desc: [
        "AI-powered analytics helps businesses uncover actionable insights from raw data.",
        "Business Intelligence organizes, analyzes, and visualizes historical and real-time data.",
        "Predictive analytics enables companies to forecast trends and improve future strategies.",
        "Our AI Data Analytics experts simplify complex data processes so businesses can focus on growth and innovation."
      ],

      questionsTitle: "Why Businesses Choose AI Data Analytics & BI?",

      questions: [
        "How can AI improve business decision-making?",
        "Can predictive analytics help identify future market trends?",
        "How does Business Intelligence support KPI tracking and reporting?",
        "Can AI detect fraud and anomalies in real time?"
      ],

      closing: [
        "AI-driven analytics empowers organizations with smarter, faster, and more accurate decisions.",
        "Modern businesses use AI and BI to stay competitive, insightful, and future-ready."
      ]
    },
    ...
    blocks: [
      {
        ...
        title: "Data Engineering & Foundation Services",
        desc:
          "Before analysis begins, data must be collected, cleaned, integrated, and structured properly. A strong data foundation ensures accurate business insights and efficient analytics workflows.",
        ...
        extra:
          "Data engineering creates the backbone for scalable AI analytics and Business Intelligence systems.",

        example:
          "Integrating customer, sales, and operational data into one centralized analytics platform."
      },

      {
        label: "AI Analytics",
        title: "AI-Powered Analytics & Modeling",
        desc:
          "AI enhances traditional analytics by identifying hidden patterns, automating insights, and improving predictive accuracy for smarter business decisions.",
        ...
        extra:
          "AI models help organizations forecast outcomes and optimize decision-making processes.",

        example:
          "Predicting customer behavior and detecting unusual financial transactions in real time."
      },

      {
        ...
        desc:
          "Business Intelligence solutions transform complex datasets into easy-to-understand dashboards, reports, and visual insights for decision-makers.",
        ...
        extra:
          "Visualization tools provide clear insights into business performance, trends, and opportunities.",

        example:
          "Using Power BI dashboards to monitor sales performance and operational KPIs."
      },

      {
        label: "Real-World Outcomes",
        title: "Business Impact of AI-Driven BI",
        desc:
          "AI-driven Business Intelligence delivers measurable improvements across industries by enhancing efficiency, customer experiences, and strategic planning.",
        ...
        extra:
          "Organizations gain faster insights, better forecasting, and stronger operational efficiency.",

        example:
          "Retail companies using AI analytics to personalize customer recommendations."
      }
    ],

    comparison: {
      title: "Traditional Analytics vs AI-Driven Data Analytics",

      data: [
        {
          feature: "Focus",
          traditional: "Descriptive reporting",
          ai: "Predictive and advanced analytics"
        },
        ...
        {
          feature: "Tools",
          traditional: "Excel & basic BI tools",
          ai: "AutoML platforms & AI-powered BI"
        },

        {
          feature: "Speed",
          traditional: "Slow processing",
          ai: "Real-time intelligent analysis"
        }
      ]
    },

    whoNeeds: {
      title: "Who Needs AI Data Analytics & BI?",

      problems: [
        "Difficulty understanding large volumes of business data",
        "Slow decision-making processes",
        "Lack of predictive insights",
        "Challenges in KPI tracking and reporting"
      ],
    ...
    approach: {
      title: "Our Approach to AI Data Analytics & BI",
      ...
      steps: [
        {
          ...
          desc:
            "We gather and integrate data from multiple business sources into a centralized system."
        },

        {
          ...
          desc:
            "We analyze historical data to identify patterns, trends, and operational insights."
        },

        {
          ...
          desc:
            "AI-powered models forecast future trends and support proactive decision-making."
        },

        {
          ...
          desc:
            "Interactive dashboards and BI tools make data easy to understand and access."
        },

        {
          ...
          desc:
            "We implement scalable AI systems that automate workflows and improve efficiency."
        }
      ],
      ...
      whyChoose: [
        {
          ...
          desc:
            "We use AI-driven analytics to provide accurate, real-time business insights."
        },

        {
          title: "Scalable BI Solutions",
          desc:
            "Our Business Intelligence systems are designed to scale with growing business data."
        },

        {
          title: "Industry-Focused Expertise",
          desc:
            "We deliver customized analytics solutions tailored to your industry needs."
        },

        {
          title: "Secure & Reliable Data Processing",
          desc:
            "We ensure strong data governance, security, and compliance standards."
        }
      ]
    },
    ...
    faq: [
      {
        q: "What is AI Data Analytics and Business Intelligence?",
        a:
          "AI Data Analytics uses machine learning and automation to uncover insights, while Business Intelligence focuses on analyzing and visualizing data for strategic decision-making."
      },

      {
        q: "How does AI improve traditional Business Intelligence?",
        a:
          "AI enhances BI through predictive forecasting, automated data analysis, anomaly detection, and natural language querying."
      },

      {
        q: "Is AI Data Analytics secure?",
        a:
          "Yes, AI analytics solutions are secure when combined with proper data governance, compliance, and cybersecurity protocols."
      },

      {
        q: "Can AI replace human analysts?",
        a:
          "No, AI automates repetitive tasks and provides predictive insights, but human expertise is still essential for strategic interpretation and decision-making."
      },

      {
        q: "Do small businesses need AI Business Intelligence?",
        a:
          "Yes, even small businesses can benefit from affordable AI-powered insights, reporting, and predictive analytics."
      }
    ]
  },

  {
    ...
    hero: {
      ...
      title: "AI Cybersecurity Services",
      subtitle: "Protect Your Business Data",
      intro: "Data is the king.",
      desc: [
        "Businesses need strong cybersecurity to protect sensitive data.",
        "AI cybersecurity uses machine learning to detect threats automatically.",
    ...
    blocks: [
      {
        label: "What is AI Cybersecurity?",
        title: "Smart Threat Detection",
        desc: "AI cybersecurity detects and responds to threats in real-time.",
        features: [
          "Prevent data theft",
      ...
      {
        label: "AI Security Features",
        title: "AI-Powered Protection",
        desc: "AI strengthens cybersecurity using automation and machine learning.",
        features: [
  ...
  {
    slug: "automation-rpa-solutions",

    hero: {
      badge: "🤖 Automation & RPA",
      title: "AI-Powered Automation and RPA Solutions",
      subtitle: "Automate Repetitive Business Tasks",
      intro: "Automation is the new age need.",
      desc: [
        "Businesses need automation to manage repetitive work efficiently.",
        "RPA automates workflows without human intervention.",
        "AI automation improves speed, accuracy, and scalability."
      ]
    },

    blocks: [
      {
        label: "What is Automation & RPA?",
        title: "Smart Process Automation",
        desc: "Automation uses technology to perform tasks automatically.",
        features: [
          "Workflow automation",
          "Invoice processing",
      ...
      {
        label: "Benefits",
        title: "Why Businesses Use Automation",
        desc: "AI automation saves time and reduces errors.",
        features: [
          "Cost saving",
          "Better efficiency",
          "Higher accuracy",
  ...
  {
    slug: "AI-seo-aeo-geo-services",

    hero: {
      badge: "📈 SEO & GEO",
      title: "AI-Powered SEO, AEO & GEO Services",
      subtitle: "Grow Your Digital Presence",
      intro: "Visibility drives business growth.",
      desc: [
        "SEO improves search engine rankings.",
        "AEO optimizes content for voice and answer engines.",
        "GEO strengthens brand authority and local visibility."
      ]
    },
    ...
    blocks: [
      {
        ...
        desc: "Improve rankings and visibility on Google.",
        features: [
...

      {
        ...
        desc: "Optimize for conversational and voice searches.",
        features: [
          "Voice search optimization",
          "Featured snippets",
...

      {
        ...
        desc: "Strengthen digital identity and local authority.",
        features: [
  ...
  {
    slug: "ai-ecommerce-services",

    hero: {
      badge: "🛒 AI E-Commerce",
      title: "Affordable AI E-Commerce Services",
      subtitle: "Personalized & Smart Retail Solutions",
      intro: "AI transforms online shopping.",
      desc: [
        "AI personalizes customer experiences.",
        "Automation improves inventory and marketing.",
        "AI chatbots and recommendations increase conversions."
      ]
    },
    ...
    blocks: [
      {
        ...
        desc: "AI helps businesses personalize online shopping.",
        features: [
          "Product recommendations",
          "AI chatbots",
          "Demand forecasting",
      ...
      {
        label: "Benefits",
        title: "How AI Helps Online Stores",
        desc: "AI improves operations and customer experience.",
        features: [
...

  {
    ...
    hero: {
      badge: "📣 AI Digital Marketing",

      title: "AI powered Digital Marketing for Data driven growth",

      subtitle: "Plan, Advertise and Promote",

      intro:
        "Business needs visibility and visibility comes after promotion through digital marketing.",

      desc: [
        "Digital marketing promotes businesses through search engines, social media and ads.",
        "AI driven digital marketing helps automate and optimize campaigns.",
        "Businesses gain better engagement, visibility and ROI using AI marketing.",
        "Digital marketing includes SEO, Email marketing, Social media marketing and Performance marketing."
      ],

      questionsTitle:
        "What is the use of AI driven Digital marketing in business?",

      questions: [
        "Can AI improve marketing campaigns?",
        "How does AI personalize customer engagement?",
        "Can AI optimize advertising and ROI?",
        "How does AI help businesses increase digital visibility?"
      ],

      closing: [
        "AI driven Digital Marketing helps businesses grow with automation and analytics.",
        "Modern marketing strategies improve engagement, visibility and digital growth."
      ]
    },

    blocks: [
      {
        label: "What is AI Digital Marketing?",

        title: "Plan, Advertise and Promote",

        desc:
          "Digital marketing is the practice of promoting products, services and brands using online channels.",
      ...
      {
        label: "What is the use of AI driven Digital marketing in business?",

        title: "Fast, Clear and Generative",

        desc:
          "AI driven Digital Marketing gives businesses a planned and realistic marketing approach using Artificial Intelligence.",
      ...
      {
        label: "Riveyra’s roles in your business?",

        title: "Optimize, Automate and Grow",

        desc:
          "We help businesses improve visibility, engagement and digital growth using AI marketing solutions.",

        features: [
          "Enhancing Visibility by SEO, AEO and GEO",
          "Streamlining Campaign, Analytics and Engagement",
          "Driving measurable Digital growth",
          "Ensure your digital presence"
        ]
      },

      {
        label: "The Future of AI Digital Marketing",

        title: "AI powered personalization and automation",

        desc:
          "The future of digital marketing depends on AI powered personalization, predictive analytics and automation.",
...

      {
        ...
        title: "Digital marketing is the backbone of modern business growth",

        desc:
          "Digital marketing helps businesses achieve sustainable growth, visibility and brand authority.",
    ...
    comparison: {
      title: "Traditional Marketing vs Modern Digital Marketing",

      data: [
        {
          feature: "Channels",
          traditional: "TV, radio, newspaper and magazine",
          ai: "Website, Social media, Emails"
        },

        {
          feature: "Reach",
          traditional: "Mostly Local",
          ai: "Globally"
        },
        ...
        {
          feature: "Engagement",
          traditional: "Low, Passive",
          ai: "High, Interactive"
        },

        {
          feature: "Result",
          traditional: "Slow, Delayed",
          ai: "Fast, quick and real time"
        },

        {
          feature: "Cost",
          traditional: "Expensive",
          ai: "Cost effective, Affordable"
        }
      ]
    },

    whoNeeds: {
      title: "Who needs AI Digital Marketing?",
      ...
      idealFor: [
        ...
        "Small and Local business owner",
      ...
      steps: [
        {
          ...
          desc: "Analyze business goals and target audience."
        },

        {
          number: "02",
          title: "Increase your Digital presence",
          desc: "Improve online visibility and reach."
        },

        {
          number: "03",
          title: "Create a Credibility",
          desc: "Build brand trust and authority."
        },

        {
          number: "04",
          title: "Enhance the Engagement",
          desc: "Increase customer interaction and engagement."
        },

        {
          number: "05",
          title: "SEO Optimization of your Business",
          desc: "Improve rankings and visibility on search engines."
        },

        {
          number: "06",
          title: "Google Business profile management",
          desc: "Optimize business profile for better reach."
        },

        {
          number: "07",
          title: "Social media campaign",
          desc: "Run targeted social media promotions."
        },

        {
          number: "08",
          title: "AI marketing",
          desc: "Use AI automation and predictive marketing."
        },

        {
          number: "09",
          title: "Creative marketing",
          desc: "Create engaging and personalized campaigns."
        }
      ]
    },
    ...
    faq: [
      {
        q: "What is AI-driven digital marketing?",

        a:
          "AI driven digital marketing uses machine learning, predictive analytics and automation to optimize campaigns and improve ROI."
      },

      {
        q: "How does AI improve marketing campaigns?",

        a:
          "AI predicts customer behavior, personalizes ads and emails, automates repetitive tasks and optimizes ad spend."
      },

      {
        ...
        a:
          "No. AI supports marketers with automation and analytics while human creativity and strategy remain essential."
      },

      {
        ...
        a:
          "AI studies customer behavior to deliver personalized recommendations, emails and targeted ads."
      },

      {
        q: "What are the benefits of AI-driven marketing?",

        a:
          "AI driven marketing improves conversion rates, campaign performance, customer engagement and ROI."
      },

      {
        ...
        a:
          "Absolutely. AI tools help identify keywords, optimize content and track rankings faster than manual methods."
      }
    ]
  },

  {
    ...
    hero: {
      badge: "🏢 Enterprise AI",
      title: "Enterprise AI Solutions for Global Scale",
      subtitle: "Automation, Analytics & Growth",
      intro: "Modern enterprises need AI transformation.",
      desc: [
        "Enterprise AI improves workflows and scalability.",
        "Machine learning automates repetitive business processes.",
    ...
    blocks: [
      {
        ...
        desc: "Automate workflows and improve business efficiency.",
        features: [
...

      {
        ...
        desc: "Cloud-based AI platforms improve flexibility and growth.",
        features: [
...

      {
        ...
        desc: "Protect enterprise systems using AI cybersecurity.",
        features: [
          "Threat detection",
