...
const CLIENTS = [
  { name: 'Client One', logo: './logo1.png', link: 'https://dgfasli.gov.in/' },
  { name: 'Client Two', logo: './logo2.jpg', link: 'https://sdrfup.in/' },
  { name: 'Client Three', logo: './logo3.jpeg', link: '' },
  { name: 'Client Four', logo: './logo6.png', link: 'https://veer-next.vercel.app/' },
  { name: 'Client Five', logo: './logo5.png', link: 'https://cwc.gov.in/' },
  { name: 'Client Six', logo: './logo7.png', link: 'https://www.shahidryfruits.com/' },
  { name: 'Client Seven', logo: './logo8.png', link: 'https://healthsanctuary.co.in/' },
  { name: 'Client Eight', logo: './logo9.png', link: 'https://niwe.res.in/' },
  { name: 'Client Nine', logo: './logo10.png', link: 'https://niwe.res.in/' },
  { name: 'Client Ten', logo: './logo11.png', link: 'https://kabilindia.in/' },
  { name: 'Client Eleven', logo: './logo12.webp', link: 'http://187.127.130.112/' },
]
  ...
  return (
    <div
      ...
      onClick={() => {
        ...
        const newTab = window.open(client.link, '_blank', 'noopener,noreferrer')
