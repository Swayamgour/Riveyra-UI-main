...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* VIDEO BG — plain cover, no extra manual zoom */}
        ...
        <div style={{
          ...
          <h1 style={{
            fontSize: isMobile
              ...
              : isTablet
                ? 'clamp(32px,4.6vw,50px)'
                : 'clamp(38px,4.6vw,64px)',
            fontFamily: 'var(--font-display)', fontWeight: 800, lineHeight: isMobile ? 1.16 : 1.08,
            marginBottom: isMobile ? 20 : 22,
            letterSpacing: isMobile ? '-1px' : '-1.6px',
          }}>
            <span style={{ display: 'block', animation: 'heroLine 0.9s 0.35s both', color: '#ffffff' }}>
              We&rsquo;re a <span className="gt">Leading IT Company</span>
            </span>
            <span style={{ display: 'block', animation: 'heroLine 0.9s 0.5s both', color: '#ffffff' }}>
              in Kanpur
            </span>
          </h1>
          ...
          <p style={{
            ...
            Leveraging innovation, technology &amp; consumer-centric strategies, Riveyra Infotech
            &mdash; a trusted IT company in Kanpur &mdash; builds extraordinary digital products
            that define tomorrow&rsquo;s businesses.
          </p>
