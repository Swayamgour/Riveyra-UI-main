...
const SERVICES = [
    {
        ...
        desc: 'React, Next.js, full-stack applications with blazing fast performance and SEO optimization.',
        longDesc: 'We build modern web applications using React, Next.js, Node.js, and cutting-edge technologies. From simple landing pages to complex enterprise platforms, we deliver scalable, performant solutions.',
        icon: '💻',
        accent: '#60a5fa',
        tags: ['React', 'Next.js', 'Node.js', 'Tailwind'],
        deliverables: ['Responsive Web App', 'API Integration', 'Admin Panel', 'SEO Setup'],
        timeline: '4-12 weeks',
    ...
    },
    {
        ...
        longDesc: 'We create powerful mobile apps using React Native and Flutter, ensuring smooth performance across both iOS and Android platforms with native-like feel.',
        icon: '📱',
        accent: '#c084fc',
        tags: ['React Native', 'Flutter', 'iOS', 'Android'],
        deliverables: ['App Store Deployment', 'Push Notifications', 'Offline Support', 'Analytics'],
        timeline: '6-16 weeks',
    ...
    },
    {
        ...
        desc: 'Data-driven marketing that drives traffic, converts leads, and scales your business.',
        longDesc: 'From SEO to paid ads, social media to email campaigns, we create holistic marketing strategies that deliver measurable ROI.',
        icon: '📈',
        accent: '#fbbf24',
        tags: ['SEO', 'PPC', 'Social Media', 'Email Marketing'],
        deliverables: ['SEO Audit', 'Content Strategy', 'Campaign Management', 'Analytics Dashboard'],
        timeline: '2-4 weeks',
    ...
    },
    {
        ...
        desc: 'Custom ERP software to streamline operations, automate workflows, and boost efficiency.',
        longDesc: 'We build tailored ERP solutions that integrate with your existing systems, automating processes and providing real-time business insights.',
        icon: '⚙️',
        accent: '#22d3ee',
        tags: ['Custom ERP', 'Inventory', 'HRMS', 'CRM'],
        deliverables: ['Requirement Analysis', 'Custom Development', 'Integration', 'Training'],
        timeline: '8-24 weeks',
    ...
    },
    {
        ...
        desc: 'Cloud migration, CI/CD pipelines, and infrastructure automation for modern teams.',
        longDesc: 'We help you leverage AWS, Azure, and GCP with automated deployment pipelines, container orchestration, and infrastructure as code.',
        icon: '☁️',
        accent: '#60a5fa',
        tags: ['AWS', 'Docker', 'Kubernetes', 'CI/CD'],
        deliverables: ['Cloud Migration', 'Pipeline Setup', 'Monitoring', 'Cost Optimization'],
        timeline: '3-8 weeks',
    ...
    },
    {
        id: 6,
        title: 'UI/UX Design',
        tagline: 'Beautiful Experiences',
        desc: 'User-centered design that converts visitors into loyal customers.',
        longDesc: 'Our design process creates intuitive, beautiful interfaces that users love. From wireframes to high-fidelity prototypes, we design for impact.',
        icon: '🎨',
        accent: '#c084fc',
        tags: ['Wireframing', 'Prototyping', 'User Research', 'Design Systems'],
        deliverables: ['User Flows', 'High-Fidelity Mockups', 'Clickable Prototype', 'Style Guide'],
        timeline: '2-6 weeks',
